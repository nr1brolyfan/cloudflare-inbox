...
- Aktualne zadanie: `SAFE-011` CI gate dla migracji, typecheck, test, lint, format i build
- Następne zadanie: `SAFE-013` recovery-safe identity policy dla pozostałych login/recovery initiation paths
...
1. Foundation milestone: realizować SAFE-011, SAFE-013 i SAFE-015 oraz domknąć operacyjne blokery SAFE-010 po ukończonej podstawie dokumentacyjnej, równolegle utrzymując otwarty SAFE-005 jako obowiązkowy gate przed pierwszą nową destrukcyjną migracją i zamknięciem etapu; ukończone SAFE-001-004, SAFE-006-009, SAFE-012 i SAFE-014 pozostają baseline, nie nowym zakresem.
