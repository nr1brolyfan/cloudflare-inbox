...
- Aktualne zadanie: `ORG-008` przypisanie istniejącego Organization Owner
- Następne zadanie: `ORG-009` utworzenie legacy domain claim
...
- [ ] ORG-012 Dodać serwis bootstrapu organizacji bez zaufania do organization ID przesłanego jako dowód dostępu. Zastąpić tymczasowy ORG-006 fresh-mailbox guard pełnym atomowym organization/mailbox bootstrap protocol; po potwierdzeniu braku starych writerów wymienić V2 receipt binding i wycofać rolling V1 promotion trigger bez usuwania retained V1 intentów.
