...
- Aktualne zadanie: `SAFE-003` wersjonowana macierz session requirements dla mailbox operations
- Następne zadanie: `SAFE-005` backup i identity-preserving restore
...
1. Foundation milestone: domknąć pozostałe bramy bieżącego etapu 1, kolejno SAFE-003, a następnie SAFE-005, SAFE-007-011, SAFE-013 i SAFE-015; ukończone SAFE-001, SAFE-002, SAFE-004, SAFE-006, SAFE-012 i SAFE-014 pozostają baseline, nie nowym zakresem.
