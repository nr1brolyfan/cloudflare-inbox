...
- Aktualne zadanie: `ORG-006` legacy/default organization
- Następne zadanie: `ORG-007` przypisanie mailboxa primary do legacy organization
...
- [ ] ORG-006 Utworzyć legacy/default organization podczas migracji istniejącego wdrożenia. Po potwierdzeniu, że stary writer nie może już działać, usunąć addytywną migracją tymczasowy ORG-005 trigger tworzący rolling-deploy V1 bootstrap intent; retained V1 markers i receipts pozostają niemutowalne.
