...
- Aktualne zadanie: `ORG-009` utworzenie legacy domain claim
- Następne zadanie: `ORG-010` canonical mailbox organizationId
...
- [ ] ORG-012 Dodać serwis bootstrapu organizacji bez zaufania do organization ID przesłanego jako dowód dostępu. Zastąpić tymczasowe ORG-006/007/008 fresh bootstrap triggery pełnym atomowym organization/mailbox/owner protocol; po potwierdzeniu braku starych writerów wymienić V2 receipt binding i wycofać rolling V1 promotion trigger bez usuwania retained V1 intentów, ancestry ani owner-assignment receipts.
