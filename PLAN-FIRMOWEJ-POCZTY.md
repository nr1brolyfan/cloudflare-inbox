...
- Aktualne zadanie: `ORG-012` atomic organization bootstrap service
- Następne zadanie: `ORG-013` organization lifecycle
...
- [ ] ORG-012 Dodać serwis bootstrapu organizacji bez zaufania do organization ID przesłanego jako dowód dostępu. Zastąpić tymczasowe ORG-005/006/008/009/010 rolling bootstrap, ancestry-column i domain-staging triggery pełnym atomowym organization/mailbox/owner/domain protocol; po potwierdzeniu braku starych writerów wymienić V2 receipt binding i wycofać compatibility protocol bez usuwania retained V1 intentów, ancestry, owner-assignment ani domain-claim receipts.
