...
- Aktualne zadanie: `ORG-010` canonical mailbox organizationId
- Następne zadanie: `ORG-011` organization-scoped user preferences
...
- [ ] ORG-010 Dodać `organizationId` do mailbox registry oraz wymaganych indeksów. Backfillować wyłącznie przez retained ORG-007 bridge po `mailboxId`, nigdy przez stałą, count/order, creator, membership, grant lub domain; atomowo zastąpić fresh materialization trigger column-era consistency protocol i zachować bridge jako provenance.
- [ ] ORG-011 Rozszerzyć user preferences o organization scope i zweryfikowany default mailbox.
- [ ] ORG-012 Dodać serwis bootstrapu organizacji bez zaufania do organization ID przesłanego jako dowód dostępu. Zastąpić tymczasowe ORG-006/007/008/009 fresh bootstrap i domain-staging triggery pełnym atomowym organization/mailbox/owner/domain protocol; po potwierdzeniu braku starych writerów wymienić V2 receipt binding i wycofać rolling V1 promotion trigger bez usuwania retained V1 intentów, ancestry, owner-assignment ani domain-claim receipts.
