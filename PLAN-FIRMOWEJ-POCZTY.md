...
- Aktualne zadanie: `SAFE-009` regresja security invariants singletona
- Następne zadanie: `SAFE-010` recovery runbook dla utraty właściciela, błędnego grantu i routingu
