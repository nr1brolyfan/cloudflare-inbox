...
- Aktualne zadanie: `SAFE-013` recovery-safe identity policy dla pozostałych login/recovery initiation paths
- Następne zadanie: `SAFE-015` restore test pełnego stanu mailboxa do tego samego mailbox ID
...
1. Foundation milestone: realizować SAFE-013 i SAFE-015 oraz domknąć otwarte blokery SAFE-005, SAFE-010 i SAFE-011; SAFE-005 pozostaje obowiązkowym gate'em przed pierwszą nową destrukcyjną migracją i zamknięciem etapu, SAFE-010 wymaga maintenance controls i staging exercise, a SAFE-011 live GitHub run oraz required status check. Ukończone SAFE-001-004, SAFE-006-009, SAFE-012 i SAFE-014 pozostają baseline, nie nowym zakresem.
