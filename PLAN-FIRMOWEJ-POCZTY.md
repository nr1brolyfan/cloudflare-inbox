...
- Aktualne zadanie: `SAFE-010` recovery runbook dla utraty właściciela, błędnego grantu i routingu
- Następne zadanie: `SAFE-011` CI gate dla migracji, typecheck, test, lint, format i build
...
1. Foundation milestone: realizować niedestrukcyjne SAFE-008-011, SAFE-013 i SAFE-015, równolegle utrzymując otwarty SAFE-005 jako obowiązkowy gate przed pierwszą nową destrukcyjną migracją i zamknięciem etapu; ukończone SAFE-001-004, SAFE-006-007, SAFE-012 i SAFE-014 pozostają baseline, nie nowym zakresem.
