...
describe("isolated current-session route", () => {
  it("returns the existing current-session wire body without rotating cookies", async () => {
  ...
  it("returns the existing unauthenticated response for absent or invalid sessions", async () => {
