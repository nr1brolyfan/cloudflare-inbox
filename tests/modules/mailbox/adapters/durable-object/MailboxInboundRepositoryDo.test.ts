...
import { InboundMessageCommitterDoLayer } from "#/modules/mailbox/adapters/durable-object/MailboxInboundRepositoryDo";
import { MailboxDomainError } from "#/modules/mailbox/domain/MailboxError";
import { CommitInboundMessageV1 } from "#/modules/mailbox/domain/MailboxInbound";
import { InboundMessageCommitter } from "#/modules/mailbox/ports/MailboxInboundRepository";
...
const runCommit = (
  ...
  Effect.runPromise(
    InboundMessageCommitter.pipe(
      ...
      Effect.provide(
        InboundMessageCommitterDoLayer.pipe(
          Layer.provide(
            Layer.succeed(
              MailboxDoNamespace,
