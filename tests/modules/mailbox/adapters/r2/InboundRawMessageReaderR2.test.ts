...
import type { InboundRawMessageR2Client as InboundRawMessageR2ClientShape } from "#/modules/mailbox/adapters/r2/InboundRawMessageReaderR2";
import {
  InboundRawMessageR2Client,
  InboundRawMessageReaderR2Layer,
} from "#/modules/mailbox/adapters/r2/InboundRawMessageReaderR2";
import { ReadInboundRawMessageInput } from "#/modules/mailbox/domain/MailboxInbound";
