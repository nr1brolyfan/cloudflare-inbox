...
import type { PasskeyCredentialAdministration as AdministrationService } from "#/auth/passkey-credential-administration";
import {
...
import { PasskeyCredentialManagementGroupLive } from "#/http/passkey-credential-management";
import { PasskeyCredentialManagementGroup } from "#/http/passkey-credential-management-contract";
...
const makeHandler = (administration: AdministrationService) => {
  ...
  const groupLive = PasskeyCredentialManagementGroupLive.pipe(
    Layer.provide(
      Layer.mergeAll(
