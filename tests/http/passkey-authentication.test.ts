...
import { PasskeyAuthenticationApiLayer } from "#/http/passkey-authentication";
import { PasskeyAuthenticationGroup } from "#/http/passkey-authentication-contract";
...
const makeHandler = (options: {
  ...
  const groupLayer = PasskeyAuthenticationApiLayer.pipe(
    Layer.provide(
