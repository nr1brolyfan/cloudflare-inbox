...
export const InboundAttachmentBlobReaderR2Live = Layer.effect(
...
export const InboundAttachmentBlobReaderR2WithRuntimeLive =
  InboundAttachmentBlobReaderR2Live.pipe(
    Layer.provide(InboundAttachmentStoreRuntimeLive)
  );
