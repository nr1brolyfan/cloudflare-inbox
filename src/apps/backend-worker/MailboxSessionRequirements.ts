...
export const MailboxOperation = {
  ...
  getDraft: "getDraft",
  getInboundAttachment: "getInboundAttachment",
...
export const MailboxSessionRequirementsMatrix = {
  ...
  operations: {
    ...
    [MailboxOperation.getContactPreferences]: unrestrictedOnly,
    [MailboxOperation.getContact]: unrestrictedOnly,
    [MailboxOperation.getDraft]: unrestrictedOnly,
    [MailboxOperation.getInboundAttachment]: unrestrictedOnly,
    ...
    [MailboxOperation.searchContacts]: unrestrictedOnly,
    [MailboxOperation.saveContact]: unrestrictedOnly,
    [MailboxOperation.removeContact]: unrestrictedOnly,
    ...
    [MailboxOperation.setThreadRead]: unrestrictedOnly,
    [MailboxOperation.subscribeChanges]: unrestrictedOnly,
    [MailboxOperation.undoSend]: unrestrictedOnly,
    [MailboxOperation.updateDraft]: unrestrictedOnly,
    [MailboxOperation.updateContactPreferences]: unrestrictedOnly,
