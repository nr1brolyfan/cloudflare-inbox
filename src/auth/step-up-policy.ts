...
import { SensitiveOperationStepUpRequired } from "./step-up-error";
...
export interface SensitiveOperationStepUpClock {
  readonly now: () => number;
}

/** Shared security clock for issuing and evaluating step-up evidence. */
export const SensitiveOperationStepUpClock =
  Context.Service<SensitiveOperationStepUpClock>(
    "cloudflare-inbox/SensitiveOperationStepUpClock"
  );

export const SensitiveOperationStepUpClockLive = Layer.succeed(
