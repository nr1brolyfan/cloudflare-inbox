...
export class PasskeyCredentialAdministrationRuntime extends Context.Service<
  PasskeyCredentialAdministrationRuntime,
  PasskeyCredentialAdministrationRuntimeShape
>()("cloudflare-inbox/PasskeyCredentialAdministrationRuntime") {}

export const PasskeyCredentialAdministrationRuntimeLayer = Layer.succeed(
  PasskeyCredentialAdministrationRuntime,
