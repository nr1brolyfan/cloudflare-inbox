...
export const InboundMimeParserConfigLayer = Layer.succeed(
...
export const InboundMimeParserPostalLayer = Layer.effect(
  InboundMimeParser,
  Effect.gen(function* () {
...
export const InboundMimeAttachmentExtractorPostalLayer = Layer.effect(
  InboundMimeAttachmentExtractor,
  Effect.gen(function* () {
    const config = yield* InboundMimeParserConfig;
